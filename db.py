...
async def create_agent_profile(name: str, voice: str = "Aoede", model: str = "gemini-2.0-flash-live-001", system_prompt: Optional[str] = None, enabled_tools: str = "[]", is_default: bool = False) -> str:
