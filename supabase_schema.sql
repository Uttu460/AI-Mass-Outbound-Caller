CREATE TABLE IF NOT EXISTS appointments (
    ...
    synced_to_calcom INTEGER NOT NULL DEFAULT 0
);
...
ALTER TABLE appointments ADD COLUMN IF NOT EXISTS timezone TEXT NOT NULL DEFAULT 'America/Chicago';
ALTER TABLE appointments ADD COLUMN IF NOT EXISTS synced_to_calcom INTEGER NOT NULL DEFAULT 0;
